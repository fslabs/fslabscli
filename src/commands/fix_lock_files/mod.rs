...
"#
    ...
    #[test]
    fn test_normalize_lockfile_sorts_patch_unused() {
        let input = "\
...
name = \"wgpu\"
version = \"24.0.5\"
source = \"git+https://example.com#abc\"
...
";
        ...
        assert_eq!(normalize_lockfile(input), expected);
    }

    #[test]
    fn test_normalize_lockfile_no_patch_unused() {
        let input = "\
# This file is automatically @generated by Cargo.
version = 4
...
version = \"0.1.0\"
";
        assert_eq!(normalize_lockfile(input), input);
    }

    #[test]
    fn test_normalize_lockfile_already_sorted() {
        let input = "\
[[patch.unused]]
name = \"alpha\"
version = \"1.0.0\"
